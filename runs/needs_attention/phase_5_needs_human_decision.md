...
- Review `runs/needs_attention/phase_5_gate_audit_current/phase5_gate_audit.md` as the current committed gate handoff before filling or validating any human decision record; first run `phase5-verify-gate-audit --audit runs/needs_attention/phase_5_gate_audit_current/phase5_gate_audit.json --output <verification_report.json>` and require `status: passed`.
