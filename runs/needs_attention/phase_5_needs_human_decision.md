...
- Review `runs/needs_attention/phase_5_gate_audit_current/phase5_gate_audit.md` as the current committed gate handoff before filling or validating any human decision record; verify the Source Artifacts sha256 still matches the decision request being reviewed.
