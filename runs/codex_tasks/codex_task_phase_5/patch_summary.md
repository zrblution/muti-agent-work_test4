...
- `/tmp/mllm_multiagent_pytest_env/bin/python -m pytest tests/test_config_cli.py -q`: `53 passed`.
- `/tmp/mllm_multiagent_pytest_env/bin/python -m pytest tests/test_config_cli.py tests/test_qwen3_vl_adapter.py tests/test_fake_adapters.py tests/test_landmark_gate.py tests/test_runner.py -q`: `101 passed`.
- `/tmp/mllm_multiagent_pytest_env/bin/python -m pytest -q`: `134 passed`.
...
- `/tmp/mllm_multiagent_pytest_env/bin/python -m stable_core.security.secret_scan --paths stable_core project_config experiments tests docs runs/needs_attention runs/subagent_reports runs/codex_tasks --output /tmp/phase5_decision_record_status_audit_secret_scan.json`: `passed`, no findings.
